...
exports.openapiDocument = {
    ...
    info: {
        ...
        version: '1.0.0',
        description: 'API para gestión de productos, ventas, clientes, proveedores, repartidores y autenticación en una tienda multitenant.',
    },
    servers: [
        {
        ...
        schemas: {
            ...
            Producto: {
                ...
                properties: {
                    ...
                    PrecioMayor: { type: 'number', format: 'double' },
            ...
            Categoria: {
                ...
                properties: {
                    ...
                    Nombre: { type: 'string' },
                    Slug: { type: 'string' },
                    CategoriaPadre_Id: { type: 'integer' },
                    Visible: { type: 'boolean' },
                },
            },
            Proveedor: {
    ...
    paths: {
        ...
        '/auth/login': {
            post: {
                ...
                description: 'Devuelve un token JWT y la información básica del usuario y de la tienda para autenticarse en el panel.',
                requestBody: {
                    required: true,
                    content: {
                        'application/json': {
        ...
        '/productos': {
            ...
            post: {
                ...
                description: 'Crea un nuevo producto para la tienda autenticada. Después se pueden asociar imágenes y variantes.',
                requestBody: {
                    required: true,
                    content: {
                        'application/json': {
        ...
        '/clientes': {
            get: {
                ...
                description: 'Devuelve los clientes de la tienda actual. Se puede filtrar por nombre, cédula o celular mediante el parámetro q.',
                parameters: [
                    {
                        name: 'q',
                        in: 'query',
